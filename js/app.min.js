...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @splidejs/splide */ \"./node_modules/@splidejs/splide/dist/js/splide.esm.js\");\n/* harmony import */ var imask__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! imask */ \"./node_modules/imask/esm/index.js\");\n/* harmony import */ var _modules_functions_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/functions.js */ \"./src/js/modules/functions.js\");\n\r\n\r\n\r\n\r\n_modules_functions_js__WEBPACK_IMPORTED_MODULE_2__.isWebp();\r\n\r\n\r\n//Слайдер галерея---------------------------------------------------\r\ndocument.addEventListener( 'DOMContentLoaded', function () {\r\n   const galleryS = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__[\"default\"]( '.gallery', {\r\n          pagination: true,\r\n          classes: {\r\n            prev  : 'gallery-next ',\r\n            next  : 'gallery-prev',\r\n          },\r\n    } ).mount();\r\n\r\n    const gallery = document.querySelector('.gallery');\r\n    const gallerySlides = gallery.querySelectorAll('.splide__pagination__page');\r\n    const allGallerySlides = gallery.querySelector('.quantity__all');\r\n    const currentGallerySlides = gallery.querySelector('.quantity__current');\r\n\r\n    allGallerySlides .innerHTML = gallerySlides.length;\r\n\r\n    galleryS.on( 'mounted move', function () {\r\n      \r\n      currentGallerySlides.innerHTML = '<span>0</span>' + (1 + galleryS.index);\r\n      \r\n    } );\r\n      });\r\n\r\n//Слайдер преимущества---------------------------------------------------\r\ndocument.addEventListener( 'DOMContentLoaded', function () {\r\n   const travel =  new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__[\"default\"]( '.travel', {\r\n          classes: {\r\n            prev  : 'travel-next ',\r\n            next  : 'travel-prev',\r\n          },\r\n    } ).mount();\r\n    const bar    = travel.root.querySelector( '.my-carousel-progress-bar' );\r\n\r\n    const travel1= document.querySelector('.travel');\r\n    const travelSlides = travel1.querySelectorAll('.splide__pagination__page');\r\n    const currentTravelSlides = travel1.querySelector('.quantity__current');\r\n    const allTravelySlides = travel1.querySelector('.quantity__all');\r\n\r\n    allTravelySlides.innerHTML = travelSlides.length;\r\n\r\n// Updates the bar width whenever the carousel moves:\r\ntravel.on( 'mounted move', function () {\r\n\r\n  var end  = travel.Components.Controller.getEnd() + 1;\r\n  var rate = Math.min( ( travel.index + 1 ) / end, 1 );\r\n  bar.style.width = String( 100 * rate ) + '%';\r\n  console.log(currentTravelSlides)\r\n  \r\n  currentTravelSlides.innerHTML = '<span>0</span>' + (1 + travel.index);\r\n  allTravelySlides.innerHTML = travelSlides.length;\r\n} );\r\n  });\r\n\r\n//Слайдеры в карточках----------------------------------------------------\r\n  document.addEventListener( 'DOMContentLoaded', function () {\r\n    const elms = document.getElementsByClassName( 'card__splide' );\r\n    for ( let i = 0; i < elms.length; i++ ) {\r\n      new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__[\"default\"]( elms[ i ],{\r\n           type   : 'loop',\r\n      classes: {\r\n        prev  : 'splide__arrow--prev card-prev',\r\n        next  : 'splide__arrow--next card-next',\r\n      },\r\n      } ).mount();\r\n}\r\n});\r\n\r\n//Слайдер команда------------------------------------------------------------\r\ndocument.addEventListener( 'DOMContentLoaded', function () {\r\n  new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__[\"default\"]( '.team__splide', {\r\n      perPage: 2,\r\n      breakpoints: {\r\n        959: {\r\n          perPage: 1,\r\n        },\r\n      },\r\n      type   : 'loop',\r\n        classes: {\r\n          prev  : 'splide__arrow--prev team-prev',\r\n          next  : 'splide__arrow--next team-next',\r\n        },\r\n  } ).mount();\r\n} );\r\n\r\n//Похожие поселки----------------------------------------------------------\r\ndocument.addEventListener( 'DOMContentLoaded', function () {\r\n  new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__[\"default\"]( '.other__splide', {\r\n    \r\n      perPage: 3,\r\n      breakpoints: {\r\n        959: {\r\n          perPage: 1,\r\n        },\r\n      },\r\n      type   : 'loop',\r\n        classes: {\r\n          prev  : 'splide__arrow--prev other-prev',\r\n          next  : 'splide__arrow--next other-next',\r\n        },\r\n  } ).mount();\r\n} );\r\n\r\n//Маска теелфон--------------------------------------------------------------\r\nlet element = document.querySelectorAll('.mask');\r\nelement.forEach(element=> {\r\n  let maskOptions = {\r\n  mask: '+7 (000) 000-00-00'\r\n};\r\nlet mask = (0,imask__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(element, maskOptions);\r\n});\r\n\r\n\r\n\r\n//Map--------------------------------------------------------------------------------\r\ndocument.addEventListener('DOMContentLoaded', function(){\r\n  ymaps.ready(function () {\r\n    const coords = document.querySelector('[data-map]').dataset.map;\r\n    const arrCoords = coords.split(',');\r\n    console.log(arrCoords)\r\n  const myMap = new ymaps.Map('map', {\r\n          center: arrCoords,\r\n          zoom: 9\r\n      }, {\r\n          searchControlProvider: 'yandex#search'\r\n      }),\r\n      \r\n      // Создаём макет содержимого.\r\n      MyIconContentLayout = ymaps.templateLayoutFactory.createClass(\r\n          '<div style=\"color: #FFFFFF; font-weight: bold;\">$[properties.iconContent]</div>'\r\n      ),\r\n\r\n      myPlacemark = new ymaps.Placemark(myMap.getCenter(), {\r\n          hintContent: 'Собственный значок метки',\r\n          balloonContent: 'Это красивая метка'\r\n      }, {\r\n          // Опции.\r\n          // Необходимо указать данный тип макета.\r\n          iconLayout: 'default#image',\r\n          // Своё изображение иконки метки.\r\n          iconImageHref: 'img/map-icon.svg',\r\n          // Размеры метки.\r\n          iconImageSize: [60, 60],\r\n          // Смещение левого верхнего угла иконки относительно\r\n          // её \"ножки\" (точки привязки).\r\n          iconImageOffset: [-5, -38]\r\n      });\r\n    //  console.log(cord)\r\n  myMap.geoObjects\r\n      .add(myPlacemark)\r\n}\r\n);\r\n})\r\n\r\n\r\n\n\n//# sourceURL=webpack://gulp-2022/./src/js/app.js?");
